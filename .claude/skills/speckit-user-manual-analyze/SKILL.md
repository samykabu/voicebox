---
name: speckit-user-manual-analyze
...
metadata:
  ...
  source: user-manual:commands/speckit.user-manual.analyze.md
---
...
5. Load specialist skills only when applicable:
   - API surface: `.specify/extensions/user-manual/skills/api-docs/SKILL.md`.
   - UI or mobile screens: `.specify/extensions/user-manual/skills/ui-screenshots/SKILL.md`.
   - Compatibility, upgrade, or release behavior: `.specify/extensions/user-manual/skills/release-docs/SKILL.md`.

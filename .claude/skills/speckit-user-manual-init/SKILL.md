...
metadata:
  ...
  source: user-manual:commands/speckit.user-manual.init.md
---
...
8. When a hosted provider was selected, load `.specify/extensions/user-manual/skills/preview-publishing/SKILL.md` and create the

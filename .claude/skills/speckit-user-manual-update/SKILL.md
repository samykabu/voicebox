---
name: speckit-user-manual-update
...
metadata:
  ...
  source: user-manual:commands/speckit.user-manual.update.md
---
...
8. Unless `--no-build`, run the audit and build scripts for all configured editions. Always create a
   ...
   provider; in that case load `.specify/extensions/user-manual/skills/preview-publishing/SKILL.md`, validate its checked-in provider

...
- Diagrams: load the relevant
  ...
  `.specify/extensions/assure/scripts/export_diagram.py` utility and `references/export.md` contract. Keep HTML sources and
  PNGs together under

...
For the native Arabic F5-TTS/Habibi engine, use the pinned CUDA 12.8 image and
Compose overlay described in [Arabic F5-TTS / Habibi on NVIDIA Docker](/overview/docker-arabic-f5-habibi).

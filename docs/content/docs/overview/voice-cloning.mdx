...
| **VoxCPM2**                 | 30        | Apache-2.0, 48 kHz, broad language coverage incl. Arabic; needs each sample's transcript |

<Callout type="info">
  Don't want to record audio? Use a curated voice from Kokoro or Qwen CustomVoice instead — see [Preset Voices](/overview/preset-voices). Or describe the voice you want and let VoxCPM2 create it — see [Designed Profiles](/overview/creating-voice-profiles#workflow-c--designed-profiles).
</Callout>
...
| A permissive licence for commercial use, or a language only it covers (e.g. Thai, Vietnamese) | **VoxCPM2** |
...
- **VoxCPM2** — Arabic, Burmese, Chinese, Danish, Dutch, English, Finnish, French, German, Greek, Hebrew, Hindi, Indonesian, Italian, Japanese, Khmer, Korean, Lao, Malay, Norwegian, Polish, Portuguese, Russian, Spanish, Swahili, Swedish, Tagalog, Thai, Turkish, Vietnamese (30)
...
<Callout type="warn">
  Voice cloning should only be used with consent. Ensure you have permission to clone someone's voice. See the [Responsible Use](https://github.com/samykabu/voicebox/blob/main/RESPONSIBLE_USE.md) guide, the project's [SECURITY.md](https://github.com/jamiepine/voicebox/blob/main/SECURITY.md) and your local laws on synthetic voice content. Audio generated from a clone is labelled "AI-generated by Voicebox" in its metadata; your reference samples are not.
</Callout>

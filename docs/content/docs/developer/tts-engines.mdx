...
Retry and regenerate do not store a one-off request description. They reuse a designed profile's saved description, because that comes from the profile.
